...
if __name__=='__main__':
    ...
    for i in range(11):
        if i<10:
            ...
            context,target,label = load_train_file('data')
            index_dict,word_vectors = get_index('lstm_data/word2vec_zi.txt')
            ...
            x1_train,x1_test,f1_train,f1_test,x2_train,x2_test,f2_train,f2_test,y_train,y_test = train_test_split(context_combined,feature_embed_q,target_combined,feature_embed_ans,label,test_size=0.1)
